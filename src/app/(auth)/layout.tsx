...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="grid min-h-dvh lg:grid-cols-[minmax(0,1fr)_minmax(0,520px)]">
      ...
      <aside className="relative hidden bg-ink px-12 py-14 text-white lg:flex lg:flex-col lg:justify-between">
        <Logo tone="light" />
        <div className="max-w-md">
          <h1 className="font-display text-[42px] leading-[1.05] tracking-[-0.03em] text-white">
